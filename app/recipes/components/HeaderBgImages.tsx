...
const HeaderBgImages = () => {
  return (
    <div className="absolute h-[300px] left-0 right-0 top-0 overflow-hidden z-0 border-b border-gray-300 bg-foreground">
      ...
      <div className="absolute left-0 bottom-0 size-[350px]">
        <Image
